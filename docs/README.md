...
현재 상태: 1.22.11. focused-v12 step 150은 실제 자유대화 비문으로 기각했다. 후속 학습을 위해 한국어 자연대화 10,000개와 Qwen36mtp·Gemma4별 다국어 대화/번역 6,000개의 고유 prompt inventory를 만들었고 Wikipedia 보충 0, split/source overlap 0, 두 endpoint preflight 통과를 확인했다. 다음 단계는 세 수집을 완료해 비누출 혼합 데이터로 재학습하는 것이다.

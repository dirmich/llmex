...
현재 상태: 1.22.10. focused-v12 정식 학습은 150 step과 heldout PPL 1.40665까지 완료했다. step 150의 390응답은 유해 거절 100%, unsafe 0, 정확도 37.69%, 멀티턴 46.67%, 정상 오거절 11.99%, loop 4건으로 실패했다. suite 밖 추론도 한국어 고유명사 조각, 불안정한 영어 문법, 한·일 혼합 비문을 보여 checkpoint를 기각했다. 다음 단계는 1,532행에 불과한 직접 다국어 teacher 대화 데이터를 대규모로 확장하는 것이다.

...
- [x] `src/llmex` 56개 모듈 전수 지도, 환경별 제작 워크북, 학습 평가 rubric과 교재 제작 메타데이터
...
**1.9.7 정식 teacher·mix·100-step pilot 완료, pilot EOS·반복 실패로 fresh full과 실제 자동/수동 품질 gate 진행 중, 외부 공개 승인 전 공개 금지**다.

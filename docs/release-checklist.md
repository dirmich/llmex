...
**1.22.13 의미 범위가 분리된 자연대화 증류 준비·600-step 혼합 SFT·focused-v12 150-step repair·private HF/GGUF export·통합 자동 품질 suite·자유대화 smoke·독립 수동 검토·외부 공개 승인 전 공개 금지**다. focused-v12와 결함 있는 expanded tranche는 기각됐고 natural-v3/v2는 아직 수집·학습 전이다. validation PPL 감소나 aggregate 품질만으로 checkpoint를 승인하지 않는다.

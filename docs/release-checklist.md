...
**1.22.12 단계적 다국어 증류·대규모 자연대화 수집·600-step 혼합 SFT·focused-v12 150-step repair·private HF/GGUF export·통합 자동 품질 suite·자유대화 smoke·독립 수동 검토·외부 공개 승인 전 공개 금지**다. step 150은 안전이 개선됐지만 자동 gate와 실제 자유대화를 실패해 기각됐다. validation PPL 감소나 aggregate 품질만으로 checkpoint를 승인하지 않는다.

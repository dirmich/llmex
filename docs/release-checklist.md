...
**1.22.8 다국어 증류·600-step 혼합 SFT·focused-v12 집중 repair·private HF/GGUF export·통합 자동 품질 suite·자유대화 smoke·독립 수동 검토·외부 공개 승인 전 공개 금지**다. 현재 600-step checkpoint는 통합 품질 gate 실패로 기각됐고 repair 학습은 아직 승인 전이다. validation PPL 감소나 aggregate 품질만으로 checkpoint를 승인하지 않는다.

...
LLMEX 1.21.3은 Wikipedia 사전학습과 분리된 assistant-only 대화 학습, 공개·teacher 비누출 mix, 결정적 능력 보정 curriculum, fresh SFT 실행 경계, 상한이 있는 token cache와 자동·수동 품질 gate를 제공한다. 기존 162응답 정확도·안전 suite와 `ko-conversation-readiness-v1` 120응답을 모두 통과해야 대화 가능 후보가 된다. v11 step 50의 준비도 기준선은 정확도 45%, 최악 35%, 멀티턴 0%로 실패했으며 manifest fingerprint `4b29ddb0…3b6`으로 byte 재유도됐다. 실제 사람 품질·법무·외부 공개 승인은 남아 있다.

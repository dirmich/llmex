...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.22.11, frozen sync | 통과 가능 |
...
| 대규모 자연대화 증류 입력 | 한국어 10,000 + Qwen 다국어 6,000 + Gemma 다국어 6,000, 고유 prompt target 일치·Wikipedia 보충 0·endpoint preflight | 입력·설정 통과, 수집 진행 전 |

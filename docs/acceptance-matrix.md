...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.17.2, frozen sync | 통과 가능 |
...
| SFT 보정 curriculum | v1~v4, 접미 v5, 핵심 앞부분 v6, exact 문맥·PII v7, 값-only 일반화 v8, 모든 user turn suite 비누출 | v8 20-step 학습 완료, 템플릿 수정 뒤 품질 재평가 필요 |

...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.12.0, frozen sync | 통과 가능 |
...
| 자동 대화 품질 | focused-v2 best SHA 고정 162응답·재유도: EOS 100%, correctness 85.80%, harmful refusal 97.22%, multi-turn 66.67% | 실패, 3차 보정 필요 |
...
| SFT 보정 curriculum | v1 9개·v2 14개·v3 잔여 7개 범주, 모든 user turn suite 비누출, target-token 질량, 원자 publish | v3 train 4,350/heldout 435행 생성·재검증, 학습 대기 |

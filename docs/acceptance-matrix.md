...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.12.1, frozen sync | 통과 가능 |
...
| 자동 대화 품질 | focused-v3 step 25 고정 162응답·재유도: EOS 99.38%, correctness 87.65%, harmful refusal 91.67%, multi-turn 50% | 실패, 성공 범주 보존 보정 필요 |
...
| SFT 보정 curriculum | v1 9개·v2 14개·v3 잔여 7개 범주, 모든 user turn suite 비누출, target-token 질량, 원자 publish | v3 200-step 및 step 25·200 품질 비교 완료, gate 실패 |

...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.13.0, frozen sync | 통과 가능 |
...
| SFT 보정 curriculum | v1·v2·v3와 보존 replay 기반 v4, 모든 user turn suite 비누출, target-token 질량, 원자 publish | v4 train 7,200/heldout 720행 생성·재검증, 학습 대기 |

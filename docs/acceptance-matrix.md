...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.16.0, frozen sync | 통과 가능 |
...
| SFT 보정 curriculum | v1~v4, 접미 v5, 핵심 앞부분 v6, exact 문맥·PII v7, 모든 user turn suite 비누출 | v7 train 8,400/heldout 840행 생성·재검증, 학습 대기 |

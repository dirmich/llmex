...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.22.22, frozen sync | 통과 가능 |
...
| natural 증류 입력 | `prompt_index` 전단사 순열, conversation act·번역 동의어/활용형 결속, canonical 본문 교집합 0, 고유 request target·Wikipedia 0·endpoint preflight | natural-v5 source와 Qwen/Gemma v4 inventory 준비·preflight 통과, Qwen 실제 수집 필요 |

...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.15.0, frozen sync | 통과 가능 |
...
| 자동 대화 품질 | focused-v5 step 50: EOS 100%, correctness 85.80%, harmful refusal 100%, multi-turn 66.67%, unsafe 0 | 실패, 문맥·정답 보정 필요 |
...
| SFT 보정 curriculum | v1~v4, 접미 counterexample v5, 핵심 앞부분+후행 조건 v6, 모든 user turn suite 비누출 | v6 train 9,200/heldout 920행 생성·재검증, 학습 대기 |

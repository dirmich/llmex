...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.16.1, frozen sync | 통과 가능 |
...
| SFT 보정 curriculum | v1~v4, 접미 v5, 핵심 앞부분 v6, exact 문맥·PII v7, 모든 user turn suite 비누출 | v7 20-step 학습과 step 5·10·20 평가·재유도 완료, exact 형식 실패 유지 |

...
| 영역 | 자동 증거 | 판정 |
|---|---|---|
| 버전·lock | 1.15.1, frozen sync | 통과 가능 |
...
| 자동 대화 품질 | focused-v6 step 20: EOS 100%, correctness 94.44%, harmful refusal 94.44%, multi-turn 66.67%, unsafe 0 | 실패, PII 거절·최종 날짜 단답 보정 필요 |
...
| SFT 보정 curriculum | v1~v4, 접미 counterexample v5, 핵심 앞부분+후행 조건 v6, 모든 user turn suite 비누출 | v6 생성·40-step 학습·step 20/40 품질 비교 완료 |
